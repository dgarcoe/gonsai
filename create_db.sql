...
CREATE TABLE IF NOT EXISTS "events"(ID TEXT NOT NULL PRIMARY KEY, BONSAIID INTEGER NOT NULL, TYPE TEXT NOT NULL, DATE TEXT, COMMENT TEXT, FOREIGN KEY(BONSAIID) REFERENCES bonsais(ID) ON DELETE CASCADE ON UPDATE NO ACTION);
